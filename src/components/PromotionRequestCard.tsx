...
const PromotionRequestCard: React.FC<PromotionRequestCardProps> = ({
  ...
  return (
    <Card
      ...
      onClick={onClick} // обробляємо клік на Card
    >
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={(e) => { e.stopPropagation(); onApprove(request.id, comment); }}
              >
              ...
              <Button
                ...
                size="sm"
                className="flex-1 gap-2"
                onClick={(e) => { e.stopPropagation(); onReject(request.id, comment); }}
              >
                <X className="w-4 h-4" />
                Отклонить
              </Button>
